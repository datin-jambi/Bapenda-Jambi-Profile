...
ARG NEXT_PUBLIC_PKB_API_HOST
ENV NEXT_PUBLIC_PKB_API_HOST=$NEXT_PUBLIC_PKB_API_HOST

ARG NEXT_PUBLIC_PKB_API_TOKEN
ENV NEXT_PUBLIC_PKB_API_TOKEN=$NEXT_PUBLIC_PKB_API_TOKEN
